...
-- -----------------------------------------------------------------------------
-- 2. TRIGGERS (Automación y Seguridad)
-- -----------------------------------------------------------------------------
...
INSERT INTO Modelos (nombre, sexo_id, altura_cm, ancho_cm, estilo_id, cuerpo_id, talla, precio_venta)
VALUES ('Alpha-Male-01', 1, 185.00, 50.00, 1, 1, 'M', 1500.00);
...
INSERT INTO Piezas (tipo_parte_id, modelo_id, origen_id, tono_acabado_id, maniqui_id, costo)
VALUES 
(1, 1, 1, 1, 1, 50.00), 
(2, 1, 1, 1, 1, 120.00), 
(3, 1, 2, 1, NULL, 45.00);
